                    ...
                    <div class="block">
                        ...
                        <div class="block__content">
                            ...
                            if ($articles_exist == true){
                                ...
                                if ($page >1){
                                    echo '<a href="/categorie.php?categorie='.$categorie.'&page='.($page - 1).'">&laquo;Предыдущая страница   </a>';
                                }
                                if ($page < $total_pages){
                                    echo '<a href="/categorie.php?categorie='.$categorie.'&page='.($page + 1).'">Следующая страница &raquo;</a>';
                                }
                                echo '</div>';
                            }
                            ?>
